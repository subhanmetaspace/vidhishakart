...
//            'photo'=>'string|required',
 	...
 	$data['photo'] = '';
        if ($request->hasFile('photo') && $request->file('photo')->isValid())
        {
            ...
            $filename   = 'BAN_' . uniqid() . '_' . str_replace(' ', '', $image->getClientOriginalName());
            $destinationPath = public_path('storage/app/public/photos/');
            $image->move($destinationPath, $filename);
            $fullUrl  = url('/storage/app/public/photos/'.$filename);
            $data['photo'] = $fullUrl;
        }
