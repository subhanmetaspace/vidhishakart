    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>AED {{number_format($cart->price,2)}}</span></td>
        </tr>
      @endforeach --}}
        ...
        <tr>
            ...
            <td><span>AED {{number_format(($order->quantity * $order->sub_total), 2)}}</span></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          {{-- <th scope="col"  class="empty">&nbsp;</th> --}}
          <th scope="col" colspan="2"class="text-right">Subtotal:</th>
          <th scope="col"colspan="2"> <span>AED {{number_format($order->sub_total, 2)}}</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          @endphp
          <th scope="col" colspan="2" class="text-right ">Shipping:</th>
          <th><span>AED {{number_format($shipping_charge[0],2)}}</span></th>
        </tr>
        <tr>
          {{-- <th scope="col" class="empty"></th> --}}
