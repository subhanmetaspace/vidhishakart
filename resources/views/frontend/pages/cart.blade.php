...
document.addEventListener("DOMContentLoaded", function () {
    const cartTableBody = document.getElementById("cart_item_list");
    const subtotalElem = document.querySelector(".order_subtotal span");
    const youPayElem = document.querySelector("#order_total_price span");
