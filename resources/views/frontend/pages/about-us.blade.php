				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="about-content">
							...
							@endphp
                            <img src="{{$settings->photo}}" alt="About DXB KART" class="pull-right ml-4 mt-5" style="width: 400px; border-radius:10px;">
							{{-- <h3>Welcome To <span>Ecommerce Laravel</span></h3>--}}
                            <h3>About <span>Us</span></h3>
                            {!! $settings->description !!}
							{{-- <p>@foreach($settings as $data) {!! $settings->description !!} @endforeach</p> --}}
							{{-- <div class="button">
